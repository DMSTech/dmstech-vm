(function($) {
    $.fn.extend({
        collapsiblePanel: function(config) {
        	var collapsed = config.collapsed != null ? config.collapsed : false;
            ...
            return $(this).each(function (index, el) {
                ...
                if (collapsed) {
                	$("<div class='collapsibleContainerTitle ui-widget-header ui-corner-top ui-corner-bottom'><ins class='ui-icon ui-icon-triangle-1-e'>&nbsp;</ins><div>" + $(this).attr("title") + "</div></div>").prependTo($(this));
                } else {
