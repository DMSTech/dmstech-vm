var zpr = function(viewFinderId, inputValues) {
  ...
  var jp2 = {
    ...
    levels: undefined,    
    url: ''
    //djatokaURL: "http://salt-prod.stanford.edu:8080/adore-djatoka/resolver?url_ver=Z39.88-2004&svc_id=info:lanl-repo/svc/getRegion&svc_val_fmt=info:ofi/fmt:kev:mtx:jpeg2000&svc.format=image/jpeg"
